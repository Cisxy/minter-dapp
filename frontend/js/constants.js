const contractAddress = "0x3495a633eDD28C116beC280425349C9C04d1e799"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Bot Lot 1 NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Bot Lot 1 NFT Project is the first collectable NFT for the highly anticipated Bot Yacht Club. Each Bot Lot 1 NFT will give one access token for one free Bot Yacht Club NFT.';
...
const p_presale_coming_soon = "We are working hard to launch this NFT Collection. Stay tuned for updates!";
